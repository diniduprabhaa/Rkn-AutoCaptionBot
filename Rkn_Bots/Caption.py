...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('🌼 Cʜᴀɴɴᴇʟ', url='https://t.me/SilvaFilmZone'),
            types.InlineKeyboardButton('☘️ Gʀᴏᴜᴘ', url='https://t.me/SilvaMovieZone')
            ],[
            types.InlineKeyboardButton('⭕ Bᴏᴛ Oᴡɴᴇʀ', url='https://t.me/DiniduSilva')
    ]]))
